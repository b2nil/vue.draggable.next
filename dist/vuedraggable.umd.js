(() => {
  ...
  var getHtmlElementFromNode = (node) => {
  ...
  function getRootInformation(tag) {
    ...
    return {
      transition,
      externalComponent,
      tag: externalComponent ? (0, import_vue.resolveComponent)(tag) : transition ? import_vue.TransitionGroup : tag
    };
  }
  ...
  function emit2(evtName, evtData) {
    (0, import_vue2.nextTick)(() => this.$emit(evtName.toLowerCase(), evtData));
  }
  ...
  var draggableComponent = (0, import_vue2.defineComponent)({
    name: "draggable",
    inheritAttrs: false,
    props,
    emits,
    ...
    render() {
      try {
        ...
        return componentStructure.render(import_vue2.h, attributes);
      } catch (err) {
        this.error = true;
        return (0, import_vue2.h)("pre", { style: { color: "red" } }, err.stack);
      }
    },
    created() {
    ...
    methods: {
      ...
      emitChanges(evt) {
        (0, import_vue2.nextTick)(() => this.$emit("change", evt));
      },
      alterList(onList) {
        if (this.list) {
          onList(this.list);
